      ...
      <div class="col-lg-7 col-md-12">
        ...
        <div style="margin-top: 28px; text-align: center;">
          <p style="font-size: 0.85rem; color: #64748b; margin: 0;">
            💡 <strong>Detail lengkap fitur dan perbandingan</strong> tersedia di <a href="<?php if($this->session->userdata('id_user')){echo site_url('subscription/pricing');}else{echo site_url('auth/login');} ?>" style="color: #1C6494; font-weight: 600; text-decoration: none;">halaman langganan</a>
          </p>
        </div>
      </div>
